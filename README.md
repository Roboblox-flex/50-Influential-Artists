...
preprocessing is used to make css more readable and concise. And adds functionality.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

Nesting. I have trouble smwetimes because the syntax is different
...
to write reusable code that can be called anywhere in the program

5. What is a JSON data?

Data written in oject form in an array that can be accessed and manipulated.
